declare module 'planout' {
  ...
  export class Experiment<InputsType, ParamsType> {
    constructor(inputs: InputsType);

    _exposureLogged: boolean;
  ...
  export namespace ExperimentSetup {
    ...
    const getExperimentInputs: <T = object>(experimentName: string) => unknown;
  }
   ...
   */
  export class Interpreter<InputsType, ParamsType> {
    /**
  ...
  export class SimpleNamespace<InputsType, ParamsType> extends Namespace<
    ParamsType
    > {
